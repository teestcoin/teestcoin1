...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Teestcoin " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"Teestcointools.com", "dnsseed.Teestcointools.com"},
    {"Teestcoinpool.org", "dnsseed.Teestcoinpool.org"},
...
static const char *strTestNetDNSSeed[][2] = {
    {"Teestcointools.com", "testnet-seed.Teestcointools.com"},
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Teestcoin is probably already running."), addrBind.ToString().c_str());
        else
